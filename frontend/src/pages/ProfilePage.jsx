        ...
        <div className="bg-base-300 rounded-xl p-6 space-y-8">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              <img src={ selectedImg || authUser.profilePic || "/avatar.jpg"} alt="profile"
                className='size-32 rounded-full object-cover border-4' />
              <label htmlFor="avatar-upload" className={`absolute bottom-0 right-0
            bg-base-content hover:scale-105 p-2 transition-all rounded-full duration-200
          ...
          <div className="form-control">
            ...
            <div className="relative">
              ...
              <p className=' px-8 py-2.5 bg-base-200 rounded-lg border'>{authUser?.fullName}</p>
            </div>
          </div>
          {/* hh */}
          <div className="form-control">
            ...
            <div className="relative">
              ...
              <p className=' px-8 py-2.5 bg-base-200 rounded-lg border'>{authUser?.email}</p>
            </div>
          </div>
          {/* ------------- */}
